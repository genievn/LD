...
/*
  ...
  Version SC_SNAPSHOT-2011-08-02/LGPL Development Only (2011-08-02)
...
,isc.A.downloadFile=function isc_DataSource_downloadFile(_1,_2,_3){this.$38i("downloadFile",_1,_2,_3)}
,isc.A.viewFile=function isc_DataSource_viewFile(_1,_2,_3){this.$38i("viewFile",_1,_2,_3)}
,isc.A.getFileURL=function isc_DataSource_getFileURL(_1,_2,_3){return this.streamFile(_1,_2,_3)}
,isc.A.streamFile=function isc_DataSource_streamFile(_1,_2,_3){_3=isc.addProperties({$38j:true,downloadResult:true},_3);return this.$38i("viewFile",_1,_2,_3)}
,isc.A.$38i=function isc_DataSource__streamFile(_1,_2,_3,_4){if(!_4)_4={};if(!_3){var _5=this.getFields();for(var _6 in _5){if(_5[_6].type=="binary"||_5[_6].type=="imageFile"){_3=_6;break}}}
...
);isc.B._maxIndex=isc.C+1;isc.A=isc.RPCManager;isc.B=isc._allFuncs;isc.C=isc.B._maxIndex;isc.D=isc._funcClasses;isc.D[isc.C]=isc.A.Class;isc.A.allowCrossDomainCalls=false;isc.A.$380=0;isc.A.onLine=!isc.isOffline();isc.A.loginStatusCodeMarker="<SCRIPT>//'\"]]>>isc_";isc.A.loginRequiredMarker="<SCRIPT>//'\"]]>>isc_loginRequired";isc.A.loginSuccessMarker="<SCRIPT>//'\"]]>>isc_loginSuccess";isc.A.maxLoginAttemptsExceededMarker="<SCRIPT>//'\"]]>>isc_maxLoginAttemptsExceeded";isc.A.$381="//isc_RPCResponseStart-->";isc.A.$382="//isc_RPCResponseEnd";isc.B.push(isc.A.xmlHttpRequestAvailable=function isc_c_RPCManager_xmlHttpRequestAvailable(){if(isc.Browser.isIE)return(isc.Comm.createXMLHttpRequest()!=null);return true}
...
_4.sendTime=isc.timeStamp();_4.changed();_4.callback="isc.RPCManager.performTransactionReply(transactionNum,results,wd)";if(_1)_4.$40c=_1;if(_5.directSubmit){isc.Comm.generateJSCallback(_4);var _14=_5.submitForm;var _15=_14.getForm();if(_14.getItem("_transaction")!=null&&isc.isA.HiddenItem(_14.getItem("_transaction")))
{_14.setValue("_transaction",this.serializeTransaction(_4));this.logInfo("Direct submit assigning request data to hidden field instead of"+" submitting as GET request");_14.setAction(this.addParamsToURL(_3,_8),true)}else{if(_5.useSimpleHttp){_14.setAction(this.addParamsToURL(_3,_8),true);_4.$387=true}else{_14.setAction(this.transactionAsGetRequest(_4,null,_8),true)}}
this.$39a(_4);if(_5.target){if(_5.target!=window)_15.target=_5.target;_14.submitForm()}else{var _16=isc.Comm.getTargetableFrame(_5.prompt);_15.target=_16.getName();_4.$ch=_16;_16.draw(_14.getID()+".submitForm()")}}else if(_5.downloadResult){if(!window.name)window.name=isc.timeStamp();var _17=_4.download_filename;if(_5.downloadToNewWindow==false||(_5.downloadToNewWindow==null&&_5.exportFilename)){var _17=window.name}
if(_5.$38j){this.clearTransaction(_4);_4.transactionRequest=this.transactionAsGetRequest(_4,_3,_8);return _4.transactionRequest}
var _11=isc.addProperties(_8,{_transaction:this.serializeTransaction(_4),protocolVersion:"1.0"});_4.$387=true;this.$39a(_4);_4.$ch=isc.Comm.sendHiddenFrame({URL:_3,httpMethod:_5.httpMethod,httpHeaders:_5.httpHeaders,contentType:_5.contentType,fields:_11,target:_17,transactionNum:_4.transactionNum,transaction:_4})}else{var _11=_8;var _18=_4.transport,_19="send"+(_18.substring(0,1).toUpperCase())+_18.substring(1);if(isc.Comm[_19]==null){this.logWarn("Attempt to send transaction with specified transport '"+_4.transport+"' failed - unsupported transaction type.");return}
this.$39a(_4);isc.RPCManager.$410.push(_4.transactionNum);_4.transactionRequest=isc.Comm[_19]({URL:_3,httpMethod:_5.httpMethod,contentType:_5.contentType,httpHeaders:_5.httpHeaders,bypassCache:_5.bypassCache,data:_5.useSimpleHttp?_5.data:null,fields:_11,target:_5.target,callbackParam:_5.callbackParam,transport:_4.transport,blocking:_5.blocking,useSimpleHttp:_5.useSimpleHttp,transactionNum:_4.transactionNum,transaction:_4})}
...
var _3;if(_2.transport=="scriptInclude"){}else if(isc.isAn.Array(_2.results)){_3=true}else if(_2.allClientOnly){_2.results={status:0};_2.receiveTime=isc.timeStamp()}else{var _4=_2.results?_2.results.indexOf(this.$381):-1;_3=_4!=-1;if(_3){var _5=_2.results;_5=this.$455(_5);try{_2.results=isc.eval(_5)}catch(e){this.logWarn("Error evaling structured RPC response: "+e+" response text: "+_5)}}}
var _6=_2.results;if(_3&&!isc.isAn.Array(_6))_6=[_6];var _7=_2.operations,_8=[];_2.$66n=true;for(var i=0,j=0;i<_7.length;i++){var _11=_7[i];var _12;if(_3&&_11.clientOnly){_12=isc.addProperties(this.createRPCResponse(_2,_11),{isStructured:false})}else{_12=isc.addProperties(this.createRPCResponse(_2,_11),{isStructured:_3,callbackArgs:_2.transport=="scriptInclude"?_6:null,results:_3?_6[j++]:_6})}
...
delete _2.abortCallbacks;delete _2.$66n;if(_2.offline)this.playbackNextOfflineTransaction();if(_2.$40c){var _15=_11.application?_11.application:this.getDefaultApplication();if(isc.isA.String(_15))_15=window[_15];_15.fireCallback(_2.$40c,"responses",[_2.responses])}}
...
);isc.B._maxIndex=isc.C+1;isc.A=isc.DataSource;isc.B=isc._allFuncs;isc.C=isc.B._maxIndex;isc.D=isc._funcClasses;isc.D[isc.C]=isc.A.Class;isc.A.$37s={};isc.B.push(isc.A.loadSchema=function isc_c_DataSource_loadSchema(_1,_2,_3){var _4=isc.DataSource.$37s;if(_4[_1]){_4[_1].add(_2);return null}
_4[_1]=[];_4[_1].add(_2);var _5=_1+"_loadSchema";_3=_3||{};if(!_3.prompt)_3.prompt="loading datasource '"+_1+"'";_3.dsName=_1;this.logInfo("performing operation: "+_5);isc.rpc.performOperation(_5,{},"isc.DS.$37y(rpcResponse,data,rpcRequest)",_3)}
,isc.A.$37y=function isc_c_DataSource__getDataSourceReply(_1,_2,_3){var _4=_2==null||_2.length==0,_5=!_4?_2[0].dsName:_3.dsName;if(_1.status!=0||_4){isc.DataSource.logError("dynamic datasource fetch failed for datasource '"+_5+"'. "+(isc.isA.String(_2)?_2:""));return}
var _6=_2[0].dsData;isc.eval(_6);var _7=isc.DS.get(_5);var _8=isc.DataSource.$37s;for(var i=0;i<_8[_5].length;i++){isc.DataSource.logInfo("calling registered callback: "+(_8[_5])[i]);this.fireCallback(_8[_5][i],"ds",[_7],_7)}
delete _8[_5]}
...
return false}
,isc.A.$50h=function isc_DataSource__handleSCServerReply(_1,_2,_3){var _4=_3._dsRequest;this.$38b(_2,_1,_4,_1,_3)}
...
if(!_4)_4=_5.getName();var _12="",_13="AUTO_FORM_"+isc.Comm.$hz++;_12+="Submitting to:<B>"+_2+"</B><BR>";_12+="<FORM ID="+_13+" METHOD="+(_8?_8:isc.Comm.sendMethod)+" ENCTYPE='application/x-www-form-urlencoded'"+" ACTION='"+_2+"'"+(_4!=window?" TARGET='"+_4+"'":"")+">";for(var _14 in _3){var _15=_3[_14];if(isc.isA.Function(_15))continue;_12+="<B>"+_14+" :</B><BR>\r&nbsp;&nbsp;"
...
,isc.A.generateJSCallback=function isc_c_Comm_generateJSCallback(_1){var _2=_1.transactionNum,_3=_1.callback,_4=isc.Comm.alwaysSendInNewWindow?"window.opener.parent.isc.Comm.hiddenFrameReply("+_2+",results,window)":"parent.isc.Comm.hiddenFrameReply("+_2+",results)";_1.requestData.jscallback=_4;this.$50c[_2]=_3}
,isc.A.getTargetableFrame=function isc_c_Comm_getTargetableFrame(_1){var _2;_2=isc.HiddenFrame.newInstance();return _2}
,isc.A.hiddenFrameReply=function isc_c_Comm_hiddenFrameReply(_1,_2,_3){var _4=this.$50c[_1];delete this.$50c[_1];if(_4)this.fireCallback(_4,"transactionNum,results,wd",[_1,_2,_3])}
,isc.A.closeOperationPromptWindow=function isc_c_Comm_closeOperationPromptWindow(_1){if(!_1||_1.transport!="hiddenFrame")return;var _2=_1.$ch;if(_2==null)return;_1.$ch=null;if(isc.isA.HiddenFrame(_2)){_2.destroy();isc.HiddenFrame.$h7()}else{if(isc.isA.Function(_2.close))_2.close()}}
);isc.B._maxIndex=isc.C+5;isc.A=isc.Canvas;isc.A.resizeThumbConstructor=isc.Canvas;isc.A.resizeThumbDefaults={width:8,height:8,overflow:"hidden",styleName:"resizeThumb",canDrag:true,canDragResize:true,getEventEdge:function(){return this.edge},autoDraw:false};isc.A=isc.Canvas;isc.B=isc._allFuncs;isc.C=isc.B._maxIndex;isc.D=isc._funcClasses;isc.D[isc.C]=isc.A.Class;isc.B.push(isc.A.$40f=function isc_c_Canvas__makeResizeThumbs(){var _1=isc.Canvas.getInstanceProperty("edgeCursorMap"),_2={},_3=isc.ClassFactory.getClass(this.resizeThumbConstructor);for(var _4 in _1){_2[_4]=_3.create({ID:"isc_resizeThumb_"+_4,edge:_4},this.resizeThumbDefaults,this.resizeThumbProperties)}
isc.Canvas.$40g=_2}
