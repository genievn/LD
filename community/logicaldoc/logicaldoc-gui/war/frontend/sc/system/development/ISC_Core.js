...
*/
if(typeof isomorphicDir == 'undefined'){isomorphicDir = 'frontend/sc/';}
...
);isc.evalBoundary;isc.B.push(isc.A.setStyleName=function isc_Canvas_setStyleName(_1){this.$tk=null;this.$tp=null;this.$81b();if(_1){this.styleName=_1;this.className=_1}
